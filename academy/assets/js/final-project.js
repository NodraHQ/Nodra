/* =====================================================================
   NODRA ACADEMY, LESSON 10: FINAL PROJECT
   ...
   - Reading progress, scrollspy, copy-to-clipboard and the quiz engine
     mirror yield.js, stablecoins.js and security.js exactly. Each module
     keeps its own independent JS by design, to reduce cross-module
     impact and keep maintenance changes local to a single module.
   - This module intentionally stores nothing about quiz completion
     anywhere (no localStorage, no account state, no cross-product call).
     The Academy stays fully self-contained; if a future accounts system
     wants to read course completion, that will be built as its own
     integration layer outside the Academy, not by this file reaching out.
   ===================================================================== */
...
(function () {
  ...
  /* ===================================================================
     Quiz. Click to answer for instant feedback, with a link back to the
