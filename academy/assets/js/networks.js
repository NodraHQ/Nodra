/* =====================================================================
   NODRA ACADEMY — LESSON 03: BLOCKCHAIN NETWORKS
   ...
   - Reading progress, scrollspy, copy-to-clipboard and the quiz engine
     mirror wallets.js (Module 02) exactly, duplicated here because
     Module 02's rules forbid editing wallets.js directly. See
     "Future Global Improvements" for the proposal to extract this into
     one shared lesson.js.
   - This module has no seed-phrase-style reveal widget, so
     initSeedDemo() has no equivalent here — everything else mirrors
...
(function () {
  ...
  /* ===================================================================
     Copy-to-clipboard — shared by the network diagram values
     =================================================================== */
    ...
    function grantModuleBadge() {
      ...
      window.nodraSupabase.auth.getSession().then(function (result) {
        ...
        fetch(window.nodraSupabaseUrl + '/functions/v1/academy-grant-module-badge', {
          ...
          body: JSON.stringify({ module_slug: '03-networks' }),
        })
