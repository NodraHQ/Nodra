/* =====================================================================
   NODRA ACADEMY, LESSON 09: SECURITY
   ...
   - Reading progress, scrollspy, copy-to-clipboard and the quiz engine
     mirror yield.js (Module 07) and stablecoins.js (Module 08) exactly.
     Each module keeps its own independent JS by design, to reduce
     cross-module impact and keep maintenance changes local to a single
     module.
   ===================================================================== */
    ...
    function grantModuleBadge() {
      ...
      window.nodraSupabase.auth.getSession().then(function (result) {
        ...
        fetch(window.nodraSupabaseUrl + '/functions/v1/academy-grant-module-badge', {
          ...
          body: JSON.stringify({ module_slug: '09-security' }),
        })
