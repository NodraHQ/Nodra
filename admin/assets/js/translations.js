...
class Translator {
    ...
    translatePage() {
        ...
        // Extensão própria desta cópia (admin/): o campo de busca de
        // usuários precisa de um placeholder traduzido, e o
        // translatePage original só lida com innerHTML via
        // data-i18n. Isso não afeta outras pastas — cada cópia deste
        // arquivo só ganha o que ela mesma precisa, mesmo padrão já
        // usado no window.nodraTranslator do account/.
